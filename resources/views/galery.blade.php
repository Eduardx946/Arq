  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form method="POST" action="{{route('foto.salvar')}}" enctype="multipart/form-data">
      		  {{ csrf_field() }}

       	 <input type="file" name="imagem" class="form-control-file" id="exampleInputFile"/>
        ...
        @foreach ($foto as $fotos)
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="data:image/jpeg;base64, {{$fotos->imagem}}" height="100%" width="100%">
